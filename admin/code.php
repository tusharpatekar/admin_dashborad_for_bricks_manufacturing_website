...
elseif(isset($_POST['slider1']))
{
    ...
    $path= "slider1";
    $image_ext1=pathinfo($image11, PATHINFO_EXTENSION);
    $image_ext2=pathinfo($image12, PATHINFO_EXTENSION);
    $image_ext3=pathinfo($image13, PATHINFO_EXTENSION);
    ...
    $cate_query1= "INSERT INTO slider  (image_one)
...
if($cate_query_run1)
{
    move_uploaded_file($_FILES['image11']['tmp_name'], $path.'/'.$update_filename1);
 
   // move_uploaded_file($_FILES['image13']['tmp_name'], $path.'/'.$update_filename3);
    echo "File uploaded";
...
if($cate_query_run1)
{
     move_uploaded_file($_FILES['image12']['tmp_name'], $path.'/'.$update_filename2);
}
}
?>